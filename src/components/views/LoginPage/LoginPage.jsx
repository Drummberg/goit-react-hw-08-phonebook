...
export default function LoginPage() {
  ...
  return (
      <><Card.Img roundedCircle src={authentication} style={{ width: '350px', marginTop: '0px', padding: '0px', position: 'absolute', top: '200px', left: '900px'}}/><Card style={{ width: '400px', margin: '150px auto', borderStyle: 'none' }}>
